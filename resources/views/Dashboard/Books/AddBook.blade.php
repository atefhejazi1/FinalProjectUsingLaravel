...
<div class="row">
    <form action="{{ url('book/store') }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="book_name" id="book_name" aria-describedby="emailHelp">
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" name="publishing_house_id" id="publishing_house_id">
                <option>أختر اسم دار النشر</option>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" name="book_rating_id" id="book_rating_id">
                <option>أختر اسم تصنيف الكتاب</option>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="issue_number" id="issue_number">
        </div>


        <button type="submit" class="btn btn-primary btn-block">أضف كتاب</button>
    </form>
</div>
<!-- row closed -->
</div>
